...
assembly_stats(){
   ...
   do
      ...
      $ANALYSIS_FOLDER/assembly/megahit/$(basename ${i%.1*})/final.contigs.fa \
...
filter_on_assembly_length(){
   ...
   do
      ...
      #megahit
      ${TOOLS_FOLDER}/bbmap/reformat.sh \
      in=${ANALYSIS_FOLDER}/assembly/megahit/$(basename ${i%.1*})/final.contigs.fa \
      out=${ANALYSIS_FOLDER}/assembly/megahit/$(basename ${i%.1*})/final_1000_filtered.fasta \
      minlength=1000
